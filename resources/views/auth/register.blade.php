                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="middleName" type="string" class="form-control{{ $errors->has('middleName') ? ' is-invalid' : '' }}" name="middleName" value="{{ old('middleName') }}">
                        ...
                        <div class="form-group row">
                            <label for="extName" class="col-md-4 col-form-label text-md-right">{{ __('Ext. Name') }}</label>

                            <div class="col-md-6">
                                <input id="extName" type="text" class="form-control{{ $errors->has('extName') ? ' is-invalid' : '' }}" name="extName" value="{{ old('extName') }}">
