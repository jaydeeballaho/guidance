    ...
    <div class="row">
        <div class="col-lg-2 col-sm-12">
            ...
            <form action="{{ route('profile.search') }}" method="POST">
                ...
                <div class="form-group">
                    <select name="college" id="" class="form-control form-control-sm" value="{{ $request->input('college') }}">
                        <option value="-1">Select college</option>
                        @foreach($colleges as $college)
                            <option
                                value="{{$college->id}}"
                                @if($college->id == $request->input('college'))
                                    selected="selected"
                                @endif
                                >{{$college->name}}
                            </option>
                ...
                <div class="form-group">
                    ...
                    <select name="genderSearch" id="genderSearch" class="form-control form-control-sm">
                        <option
                            value="Any"
                            @if($request->input('genderSearch') == "Any")
                                selected="selected"
                            @endif
                            >Any gender
                        </option>
                ...
                <div class="form-group">
                    <h5>Personal Data Form Verification</h5>
                    <div class="form-check">
                    ...
                    <tbody id="searchResults">
                        @foreach($students as $stud)
                            ...
                            >
                                ...
                                <td>{{ $stud->course()->withTrashed()->first()->name ?? ""}}</td>
                                <td>
