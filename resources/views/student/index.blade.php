...
@section('content')
    ...
    <div class="container mt-4 guidance-form">
        <form action="{{ route('profile.update') }}" id="guidanceForm" method="POST">
            @csrf
            <div class="row" id="page1">
                <div class="col-12" id="alert">
                    <div class="d-md-none alert alert-info mt-0" role="alert">
                        <p>We recommend you to open this in your desktop for optimal experience.</p>
                    </div>
                    @if(auth()->user()->alerts()->get()->count() > 0)
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <h4 class="alert-heading">You have not yet adequately provided some information.</h4>
                            @foreach(auth()->user()->alerts()->get() as $alert)
                                <p class="">{{ $alert->message }}</p>
                                <hr>
                                <p class="mb-0">- {{ $alert->counsel }}</p>
                            @endforeach
                    ...
                    @if($student_info['student']->infoVerification == 0)
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            <p class="mb-0 pd-0 pl-4">Your Personal Data Form has been submitted. Verification will take a while.</p>
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                ...
                <div class="col-12 text-center mb-4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isOldStudent" id="student_statusNew" value="0" {{ !($student_info['student']->isOldStudent) ? 'checked' : '' }}>
                        <label class="form-check-label" for="student_statusNew">
                            New Student
                        </label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="isOldStudent" id="student_statusOld" value="1" {{ ($student_info['student']->isOldStudent) ? 'checked' : '' }}>
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <select name="gender" id="" class="form-control">
                            <option value="Male" {{ ($student_info['student']->gender == 'Male') ? 'selected="selected"' : '' }}>Male</option>
                            <option value="Female" {{ ($student_info['student']->gender == 'Female') ? 'selected="selected"' : '' }}>Female</option>
                            <option value="Lesbian" {{ ($student_info['student']->gender == 'Lesbian') ? 'selected="selected"' : '' }}>Lesbian</option>
                            <option value="Gay" {{ ($student_info['student']->gender == 'Gay') ? 'selected="selected"' : '' }}>Gay</option>
                            <option value="Bisexual" {{ ($student_info['student']->gender == 'Bisexual') ? 'selected="selected"' : '' }}>Bisexual</option>
                            <option value="Transgender" {{ ($student_info['student']->gender == 'Transgender') ? 'selected="selected"' : '' }}>Transgender</option>
                            <option value="Other" {{ ($student_info['student']->gender == 'Other') ? 'selected="selected"' : '' }}>Others</option>
                            <option value="N/A" {{ ($student_info['student']->gender == 'N/A') ? 'selected="selected"' : '' }}>Prefer not to say</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label for="">Religion</label>
                        <select name="religion" id="" class="form-control">
                            <option value="Aglipayan" {{ ($student_info['student']->religion == 'Aglipayan') ? 'selected="selected"' : ''}}>Aglipayan</option>
                            <option value="Association of Fundamental Baptist Churches in the Philippines" {{ ($student_info['student']->religion == 'Association of Fundamental Baptist Churches in the Philippines') ? 'selected="selected"' : ''}}>Association of Fundamental Baptist Churches in the Philippines</option>
                            <option value="Bible Baptist Church" {{ ($student_info['student']->religion == 'Bible Baptist Church') ? 'selected="selected"' : ''}}>Bible Baptist Church</option>
                            <option value="Buddhist" {{ ($student_info['student']->religion == 'Buddhist') ? 'selected="selected"' : ''}}>Buddhist</option>
                            <option value="Church of Christ" {{ ($student_info['student']->religion == 'Church of Christ') ? 'selected="selected"' : ''}}>Church of Christ</option>
                            <option value="Convention of the Philippine Baptist Church" {{ ($student_info['student']->religion == 'Convention of the Philippine Baptist Church') ? 'selected="selected"' : ''}}>Convention of the Philippine Baptist Church</option>
                            <option value="Crusaders of the Divine Church of Christ Inc." {{ ($student_info['student']->religion == 'Crusaders of the Divine Church of Christ Inc.') ? 'selected="selected"' : ''}}>Crusaders of the Divine Church of Christ Inc.</option>
                            <option value="Evangelical Christian Outreach Foundation" {{ ($student_info['student']->religion == 'Evangelical Christian Outreach Foundation') ? 'selected="selected"' : ''}}>Evangelical Christian Outreach Foundation</option>
                            <option value="Evangelicals (PCEC)" {{ ($student_info['student']->religion == 'Evangelicals (PCEC)') ? 'selected="selected"' : ''}}>Evangelicals (PCEC)</option>
                            <option value="Faith Tabernacle Church (Living Rock Ministries)" {{ ($student_info['student']->religion == 'Faith Tabernacle Church (Living Rock Ministries)') ? 'selected="selected"' : ''}}>Faith Tabernacle Church (Living Rock Ministries)</option>
                            <option value="Iglesia Ni Cristo" {{ ($student_info['student']->religion == 'Iglesia Ni Cristo') ? 'selected="selected"' : ''}}>Iglesia Ni Cristo</option>
                            <option value="Iglesia sa Dios Espiritu Santo Inc." {{ ($student_info['student']->religion == 'Iglesia sa Dios Espiritu Santo Inc.') ? 'selected="selected"' : ''}}>Iglesia sa Dios Espiritu Santo Inc.</option>
                            <option value="Igreja Católica Apostólica Brasileira nas Filipinas" {{ ($student_info['student']->religion == 'Igreja Católica Apostólica Brasileira nas Filipinas') ? 'selected="selected"' : ''}}>Igreja Católica Apostólica Brasileira nas Filipinas</option>
                            <option value="Islam" {{ ($student_info['student']->religion == 'Islam') ? 'selected="selected"' : ''}}>Islam</option>
                            <option value="Jehovah's Witnesses" {{ ($student_info['student']->religion == 'Jehovah\'s Witnesses') ? 'selected="selected"' : ''}}>Jehovah's Witnesses</option>
                            <option value="Jesus Is Lord Church Worldwide" {{ ($student_info['student']->religion == 'Jesus Is Lord Church Worldwide') ? 'selected="selected"' : ''}}>Jesus Is Lord Church Worldwide</option>
                            <option value="Lutheran Church in the Philippines" {{ ($student_info['student']->religion == 'Lutheran Church in the Philippines') ? 'selected="selected"' : ''}}>Lutheran Church in the Philippines</option>
                            <option value="Philippine Benevolent Missionaries Association" {{ ($student_info['student']->religion == 'Philippine Benevolent Missionaries Association') ? 'selected="selected"' : ''}}>Philippine Benevolent Missionaries Association</option>
                            <option value="Philippine Independent Catholic Church" {{ ($student_info['student']->religion == 'Philippine Independent Catholic Church') ? 'selected="selected"' : ''}}>Philippine Independent Catholic Church</option>
                            <option value="Roman Catholic" {{ ($student_info['student']->religion == 'Roman Catholic') ? 'selected="selected"' : ''}}>Roman Catholic</option>
                            <option value="Seventh-day Adventist" {{ ($student_info['student']->religion == 'Seventh-day Adventist') ? 'selected="selected"' : ''}}>Seventh-day Adventist</option>
                            <option value="The Church of Jesus Christ of Latter-day Saints" {{ ($student_info['student']->religion == 'The Church of Jesus Christ of Latter-day Saints') ? 'selected="selected"' : ''}}>The Church of Jesus Christ of Latter-day Saints</option>
                            <option value="United Church of Christ in the Philippines" {{ ($student_info['student']->religion == 'United Church of Christ in the Philippines') ? 'selected="selected"' : ''}}>United Church of Christ in the Philippines</option>
                            <option value="United Pentecostal Church (Philippines) Inc." {{ ($student_info['student']->religion == 'United Pentecostal Church (Philippines) Inc.') ? 'selected="selected"' : ''}}>United Pentecostal Church (Philippines) Inc.</option>
                            <option value="Unión Espiritista Cristiana de Filipinas, Inc." {{ ($student_info['student']->religion == 'Unión Espiritista Cristiana de Filipinas, Inc.') ? 'selected="selected"' : ''}}>Unión Espiritista Cristiana de Filipinas, Inc.</option>
                            <option value="Non-Roman Catholic and Protestant (NCCP)" {{ ($student_info['student']->religion == 'Non-Roman Catholic and Protestant (NCCP)') ? 'selected="selected"' : ''}}>Non-Roman Catholic and Protestant (NCCP)</option>
                            <option value="Other Protestants" {{ ($student_info['student']->religion == 'Other Protestants') ? 'selected="selected"' : ''}}>Other Protestants</option>
                            <option value="Tribal Religions" {{ ($student_info['student']->religion == 'Tribal Religions') ? 'selected="selected"' : ''}}>Tribal Religions</option>
                            <option value="Other Baptists" {{ ($student_info['student']->religion == 'Other Baptists') ? 'selected="selected"' : ''}}>Other Baptists</option>
                            <option value="None" {{ ($student_info['student']->religion == 'None') ? 'selected="selected"' : ''}}>None</option>
                            <option value="Others" {{ ($student_info['student']->religion == 'Others') ? 'selected="selected"' : ''}}>Others</option>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="tellCellNo" value="{{ $student_info['student']->tellCellNo }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="fatherSchoolAttended" id="" cols="30" rows="4" class="form-control" name="fatherSchoolAttended">{{ $student_info['family_info']->fatherSchoolAttended }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Hobbies & Interests</label>
                        <textarea name="fatherHobbiesInterests" id="" cols="30" rows="4" class="form-control" name="fatherHobbiesInterests">{{ $student_info['family_info']->fatherHobbiesInterests }}</textarea>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <textarea id="" cols="30" rows="3" class="form-control" name="motherAddress">{{ $student_info['family_info']->motherAddress }}</textarea>
                            </div>
                            <div class="col-12 mt-2">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-3">
                                <input type="number" class="form-control" name="spouseAge" value="{{ $student_info['family_info']->spouseAge }}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-12">
                                <textarea id="" cols="30" rows="3" class="form-control" name="spouseAddress">{{ $student_info['family_info']->spouseAddress }}</textarea>
                            </div>
                            <div class="col-12 mt-2">
                    ...
                    <div class="form-group">
                        <label for="">Schools Attended</label>
                        <textarea name="spouseSchoolAttended" id="" cols="30" rows="4" class="form-control" name="spouseSchoolAttended">{{ $student_info['family_info']->spouseSchoolAttended }}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="">Hobbies & Interests</label>
                        <textarea name="spouseHobbiesInterests" id="" cols="30" rows="4" class="form-control" name="spouseHobbiesInterests">{{ $student_info['family_info']->spouseHobbiesInterests }}</textarea>
                    </div>
                </div>
            ...
            <div class="row d-none" id="page2">
                ...
                <div class="col-12">
                    ...
                    <div class="form-row" id="listChildrenFamily">
                        ...
                        <div class="col-12 d-none" id="individualChild">
                            <div class="form-row">
                                ...
                                <div class="col-md-1 col-sm-4 form-group">
                                    ...
                                    <input type="number" name="childrenAge[]" class="form-control form-control-sm" min="0">
                                </div>
                                <div class="col-md-1 col-sm-4 form-group">
                ...
                <div class="col-12">
                    ...
                    <div class="form-row" id="schoolsAttended">
                        ...
                        <div class="col-12 d-none" id="schoolEntry">
                            <div class="form-row">
                                <div class="col-md-3 col-sm-12 form-group">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 col-sm-12 form-row" id="subjectsLiked">
                            ...
                            <div class="col-12 form-row mt-2 d-none" id="singleSubjectLiked">
                                <div class="col-8">
                        ...
                        <div class="col-md-6 col-sm-12 form-row" id="subjectsDisliked">
                            ...
                            <div class="col-12 form-row mt-2 d-none" id="singleSubjectDisliked">
                                <div class="col-8">
                            ...
                            <div class="form-row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_familySuggestion" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_familySuggestion) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_familyTradition" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_familyTradition) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_personalChoice" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_personalChoice) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_friendChoice" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_friendChoice) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_teacherChoice" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_teacherChoice) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="hidden" name="chooseSchool_followingIAdmired" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->chooseSchool_followingIAdmired) ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="hidden" name="howComeSchool_personalChoice" id="" class="form-check-input" value="0"  {{ (!$student_info['educational_background']->howComeSchool_personalChoice) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="hidden" name="howComeSchool_parentChoice" id="" class="form-check-input" value="0"  {{ (!$student_info['educational_background']->howComeSchool_parentChoice) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <div class="form-group">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="hidden" name="howComeSchool_friendRecommendation" id="" class="form-check-input" value="0"  {{ (!$student_info['educational_background']->howComeSchool_friendRecommendation) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input type="hidden" name="howComeSchool_others" id="" class="form-check-input" value="0"  {{ (!$student_info['educational_background']->howComeSchool_othersSpecified) ? 'checked' : '' }}>
            ...
            <div class="row d-none" id="page3">
                <div class="col-12">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_family" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_family) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_savings" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_savings) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_partTime" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_partTime) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_governmentAid" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_governmentAid) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_scholar" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_scholar) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="hidden" name="financialAid_others" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->financialAid_othersSpecified) ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_barely" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_barely) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_failedMost" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_failedMost) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_hardTimePassing" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_hardTimePassing) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_difficultySomeSubjects" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_difficultySomeSubjects) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_fearFailSem" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_fearFailSem) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_confidentFinishCourse" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_confidentFinishCourse) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="hidden" name="selfEval_stillAdjusting" id="" class="form-check-input" value="0" {{ (!$student_info['educational_background']->selfEval_stillAdjusting) ? 'checked' : '' }}>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-check">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="physical_wearGlasses" value="1" id="" class="form-check-input" {{ ($student_info['health_living']->physical_wearGlasses) ? 'checked' : '' }}>
                                            wearing glasses
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" name="physical_wearGlasses" value="0" id="" class="form-check-input" {{ (!$student_info['health_living']->physical_wearGlasses) ? 'checked' : '' }}>
                                            not wearing glasses
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="physicalPrograms_aerobic" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->physicalPrograms_aerobic) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="physicalPrograms_stretchSwim" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->physicalPrograms_stretchSwim) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="physicalPrograms_weightLiftBodyBuild" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->physicalPrograms_weightLiftBodyBuild) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="physicalPrograms_dancingGymnastics" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->physicalPrograms_dancingGymnastics) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="physicalPrograms_gamesSports" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->physicalPrograms_gamesSports) ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-row">
                            <div class="col-md-3 col-sm-12">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="sufferingPhysicalAilment_allergy" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->sufferingPhysicalAilment_allergy) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="sufferingPhysicalAilment_asthma" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->sufferingPhysicalAilment_asthma) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="sufferingPhysicalAilment_migraneDizziness" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->sufferingPhysicalAilment_migraneDizziness) ? 'checked' : '' }}>
                                ...
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="hidden" name="sufferingPhysicalAilment_stomachache" id="" class="form-check-input" value="0" {{ (!$student_info['health_living']->sufferingPhysicalAilment_stomachache) ? 'checked' : '' }}>
            ...
            <div class="row d-none" id="page4">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group-inline">
                        ...
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input type="radio" name="previousCounseling" value="1" id="" class="form-check-input" {{ ($student_info['misc']->previousCounseling) ? 'checked' : ''}}>
                                Yes
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input type="radio" name="previousCounseling" value="0" id="" class="form-check-input" {{ ($student_info['misc']->previousCounseling) ? 'checked' : ''}}>
                                No
                            </label>
                        </div>
                    </div>
...
<script>
    $(document).ready(function (){
        var status = @php echo $student_info['student']->infoVerification @endphp

        if(status == 0){ //Pending
            $('#navbar').removeClass('bg-primary');
            $('#navbar').addClass('bg-info');
        }
        else if(status == 2){ //Not approved
            $('#navbar').removeClass('bg-primary');
    ...
    $('#addChildEntry').click(function (){
        $('#individualChild').clone().removeClass('d-none').appendTo('#listChildrenFamily');
    });

    //Page 2, schools attended
    $('#addSchoolEntry').click(function (){
        $('#schoolEntry').clone().removeClass('d-none').appendTo('#schoolsAttended');
    });

    //Page 2, subjects liked
    $('#addSubjectLiked').click(function (){
        $('#singleSubjectLiked').clone().removeClass('d-none').appendTo('#subjectsLiked');
    });

    //Page 2, subjects disliked
    $('#addSubjectDisliked').click(function (){
        $('#singleSubjectDisliked').clone().removeClass('d-none').appendTo('#subjectsDisliked');
    });

    //Height
    $('#feet_inches_selected').click(function (){
        if($('#height_input_ft_in').hasClass('d-none'))
            $('#height_input_ft_in').removeClass('d-none');

        if(!$('#height_input_m').hasClass('d-none'))
            $('#height_input_m').addClass('d-none');

        m = $('#physical_height_m').val()

        feet = Math.trunc(m * 3.28084)

        inch = Math.trunc(((m * 3.28084) - feet) * 12)

        $('#physical_height_ft').val(feet);
        $('#physical_height_in').val(inch);
    });

    $('#meters_selected').click(function (){
        if(!$('#height_input_ft_in').hasClass('d-none'))
            $('#height_input_ft_in').addClass('d-none');

        if($('#height_input_m').hasClass('d-none'))
            $('#height_input_m').removeClass('d-none');

        feet = parseInt($('#physical_height_ft').val());

        inch_to_feet = ($('#physical_height_in').val() / 12) + feet;
        feet_to_meter = inch_to_feet * 0.3048;

        $('#physical_height_m').val(feet_to_meter);
    });

    //Weight
    $('#kg_selected').click(function (){
        if($('#weight_input_kg').hasClass('d-none'))
            $('#weight_input_kg').removeClass('d-none')

        if(!$('#weight_input_lb').hasClass('d-none'))
            $('#weight_input_lb').addClass('d-none')

        lb = $('#physical_weight_lb').val();
        kg = lb * 0.45359237;

        $('#physical_weight_kg').val(kg);
    });

    $('#lb_selected').click(function (){
        if(!$('#weight_input_kg').hasClass('d-none'))
            $('#weight_input_kg').addClass('d-none')

        if($('#weight_input_lb').hasClass('d-none'))
            $('#weight_input_lb').removeClass('d-none')

        kg = $('#physical_weight_kg').val();
        lb = kg * 2.20462;

        $('#physical_weight_lb').val(lb);
    });
</script>
@endsection